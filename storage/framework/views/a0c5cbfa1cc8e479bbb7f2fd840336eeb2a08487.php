                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center">
                                                <?php if($data->image): ?>
                                                <img src="<?php echo e(asset('images/'.$data->image)); ?>" height="120px" width="220px" alt="">
                                                <?php endif; ?>
                                            </td>
                                            ...
                                            <td style="text-align: center">
                                                <a href="<?php echo e(route('customer.tran',$data->id)); ?>"><i class="fa fa-eye" style="color: #191987;font-size:16px;"></i></a>
...
<?php $__env->startSection('script'); ?>
    <script>
        $(document).ready(function () {
            ...
            //
            var url = "<?php echo e(URL::to('/admin/customer')); ?>";
            // console.log(url);
            ...
            var depositurl = "<?php echo e(URL::to('/admin/customer-deposit')); ?>";
            // console.log(url);
...
<?php echo $__env->make('admin.layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\work\kuddus_oil_store\resources\views/admin/customer/index.blade.php ENDPATH**/ ?>