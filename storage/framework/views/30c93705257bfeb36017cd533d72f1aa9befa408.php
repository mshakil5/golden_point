  ...
  <body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <?php if(Auth::user()->is_type == 'admin' || in_array('3', json_decode(Auth::user()->staff->role->permissions))): ?>
        <li><a class="app-menu__item" href="<?php echo e(route('admin.customer')); ?>" id="customer"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Customer</span></a></li>
        <?php endif; ?>
...
<?php /**PATH D:\xampp\htdocs\work\kuddus_oil_store\resources\views/admin/layouts/admin.blade.php ENDPATH**/ ?>