        ...
        <div class="tab-content">
            ...
            <div class="tab-pane active" id="user-image">
              <div class="tile user-settings">
                ...
                <form>
                  <div class="row">
                    <input id="profileid" value="<?php echo e($profile_data->id); ?>" type="hidden">
                    <div class="col-md-8 mb-4">
                        <div style="display: flex;">
                            <div>
                                <img class="imgPreview img img-circle"
                                 width="80" src="<?php echo e(asset('images/'.$profile_data->photo)); ?>">
                            </div>
                ...
                <form>
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <input class="form-control" id="name" value="<?php echo e($profile_data->name); ?>" type="text">
                    </div>
                    <div class="col-md-6">
                      <label>Email</label>
                      <input class="form-control"  id="adminemail" value="<?php echo e($profile_data->email); ?>" type="text">
                    </div>
                    <div class="clearfix"></div>
                    <div class="col-md-6">
                      <label>Phone</label>
                      <input class="form-control" id="phone" value="<?php echo e($profile_data->phone); ?>" type="text">
                    </div>
                    <div class="col-md-6">
                      <label>City</label>
                      <input class="form-control" id="city" value="<?php echo e($profile_data->city); ?>" type="text">
                    </div>
                    <div class="col-md-6">
                      <label>Country</label>
                      <input class="form-control" id="country" value="<?php echo e($profile_data->country); ?>" type="text">
                    </div>
                    <div class="col-md-6">
                      <label>Postal Code</label>
                      <input class="form-control" id="postal_code" value="<?php echo e($profile_data->postal_code); ?>" type="text">
                    </div>
                    <div class="col-md-6">
                      <label>About</label>
                      <input class="form-control" id="about" value="<?php echo e($profile_data->about); ?>" type="text">
                    </div>
                    <div class="col-md-6">
                      <label>Address</label>
                      <textarea class="form-control"  id="address" type="text"><?php echo e($profile_data->address); ?></textarea>
                    </div>
                    <div class="clearfix"></div>
                  </div>
                  <hr>
...
<script>
  $(document).ready(function(){
      ...
      //
      var url = "<?php echo e(URL::to('/admin/profile')); ?>";
      //console.log(url);
      ...
      var passwordurl = "<?php echo e(URL::to('/admin/changepassword')); ?>";
            ...
            var imgurl = "<?php echo e(URL::to('/admin/image')); ?>";
...
<?php echo $__env->make('admin.layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\work\golden_point\resources\views/admin/profile.blade.php ENDPATH**/ ?>